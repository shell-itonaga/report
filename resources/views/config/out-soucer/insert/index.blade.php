<x-app-layout>
    ...
    <x-slot name="header">
        <div class="text-base md:text-2xl">外注者新規登録</div>
    </x-slot>
        ...
        <div class="container">
            <div class="max-w-xl mx-auto">
                <div class="my-2 px-2 py-2 rounded-lg border-gray-300 border-1 bg-white">
                    <form name="input" class="mx-auto" method="POST" action="{{ route('insert.out-soucer.confirm') }}">
@csrf
                        ...
                        <div class="mx-auto my-2 text-center">
                            ...
                            <button class="btn btn-primary btn-lg mx-2" type="reset" id="reset"> ク リ ア </button>
