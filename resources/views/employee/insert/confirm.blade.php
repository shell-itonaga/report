<x-app-layout>
    ...
    <x-slot name="header">
        <div class="text-base md:text-2xl">社員情報 登録確認</div>
    </x-slot>
        ...
        <div class="container">
            <div class="max-w-xl mx-auto">
                ...
                <div class="my-2 px-2 py-2 rounded-lg border-gray-300 border-1 bg-white">
                    <form name="input" class="mx-auto" method="POST" action="{{ route('employee.insert-confirm') }}">
@csrf
                        <!-- ユーザID -->
...
@else
                            <div>一般</div>
@endif
                            <input type="hidden" name="user_authority" id="user_authority" value="{{ $user->user_authority }}">
                        </div>
                        ...
                        <div class="col-sm mb-2">
                            ...
                            <div class="text-primary col-form-label-sm"><i class="fas fa-exclamation-circle"></i>&nbsp;セキュリティの関係上、パスワードは表示されません</div>
