<x-app-layout>
    ...
    <x-slot name="header">
        <div class="text-base md:text-2xl">日報集計</div>
    </x-slot>
            ...
            <div class="accordion-item">
                ...
                <div id="panelsOpen-collapse" class="accordion-collapse collapse show" aria-labelledby="panelsOpen-heading">
                    <div class="accordion-body">
                        <form name="input" class="mx-auto" method="GET" action="{{ route('summary.search') }}">
@csrf
...
@endforeach
                                ...
                                <div class="col-sm-3">
                                    ...
                                    <select class="select-work-type form-select" id="work_type" name="work_type">
...
@endforeach
                            ...
                            <div class="mx-auto mt-4 text-center">
                                <a href="{{ route('summary.index') }}"><button class="btn btn-primary btn-lg mx-2" type="button"> クリア </button></a>
...
@if(count($summarys) > 0)
        <!-- 検索結果表示 -->
        <div class="alert alert-info mt-4 mx-auto max-w-3xl text-center text" role="alert">該当全レコード数：{{ session('total_count') }}件&emsp;／&emsp;合計作業時間：{{ sprintf("%.2fh", session('total_time')) }}</div>
