<x-app-layout>
    ...
    <x-slot name="header">
        ...
        <div class="text-sm md:text-lg">日報修正確認</div>
    </x-slot>
...
@csrf
        <div class="form-group py-4 ml-4">
            ...
            <input type="hidden" class="form-control" value="{{ $selection->edit_id }}" id="edit_id" name="edit_id">
            ...
            <div class="row-auto border-bottom">
                ...
                <p class="text-xl">{{ $selection->work_date }}</p>
                <input type="hidden" class="form-control" value="{{ $selection->work_date }}" id="work_date" name="work_date">
            </div>
            ...
            <div class="row-auto border-bottom">
                ...
                <input type="hidden" value="{{ $selection->customer_code }}" id="customer_code" name="customer_code">
            </div>
            ...
            <div class="row-auto border-bottom">
                ...
                <input type="hidden" value="{{ $selection->order_id }}" id="order_id" name="order_id">
            </div>
            ...
            <div class="row-auto border-bottom">
                ...
                <input type="hidden" value="{{ $selection->serial_id }}" id="serial_id" name="serial_id">
            </div>
            ...
            <div class="row-auto border-bottom">
                ...
                <input type="hidden" value="{{ $selection->unit_id }}" id="unit_id" name="unit_id">
            </div>

            <div class="row-auto border-bottom">
                <label for="model_name" class="col-form-label">型&emsp;式<span class="badge bg-secondary mx-2 my-0">任意</span></label>
                <p class="text-xl">{{ $selection->model_name }}</p>
                <input type="hidden" pattern="^[0-9A-Za-z-_]+$" class="form-control" value="{{ $selection->model_name }}" id="model_name" name="model_name">
            </div>

            <div class="row-auto border-bottom">
                <label for="unit_name" class="col-form-label">ユニット名<span class="badge bg-secondary mx-2 my-0">任意</span></label>
                <p class="text-xl">{{ $selection->unit_name }}</p>
                <input type="hidden" class="form-control" value="{{ $selection->unit_name }}" id="unit_name" name="unit_name">
            </div>
            <div class="row-auto border-bottom">
                ...
                <input type="hidden" value="{{ $selection->work_type }}" id="work_type" name="work_type">
            </div>
            ...
            <div class="row-auto border-bottom">
                ...
                <input type="hidden" value="{{ $selection->work_class }}" id="work_class" name="work_class">
            </div>
            ...
            <div class="row-auto border-bottom">
                ...
                <input type="hidden" value="{{ $selection->work_detail }}" id="work_detail" name="work_detail">
            </div>

            <div class="row-auto border-bottom">
                <label for="work_time" class="col-form-label">作業時間<span class="badge bg-danger mx-2 my-0">必須</span></label>
                <p class="text-xl">{{ sprintf('%.2fh', $selection->work_time) }}</p>
                <input type="hidden" class="form-control" value="{{ $selection->work_time }}"id="work_time" name="work_time">
            </div>

            <div class="row-auto border-bottom">
                <label for="remarks" class="col-form-label">備&emsp;考<span class="badge bg-secondary mx-2 my-0">必須</span></label>
                <p class="text-xl">{{ $selection->remarks }}</p>
                <input type="hidden" class="form-control" value="{{ $selection->remarks }}"id="remarks" name="remarks">
            </div>
