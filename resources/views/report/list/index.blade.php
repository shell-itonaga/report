<x-app-layout>
    ...
    <x-slot name="header">
        ...
        <div class="text-sm md:text-lg">日報一覧</div>
    </x-slot>
            ...
            <div class="accordion-item">
                ...
                <div id="panelsOpen-collapse" class="accordion-collapse collapse show" aria-labelledby="panelsOpen-heading">
                    <div class="accordion-body">
                        <form name="input" class="mx-auto" method="GET" action="{{ route('list.search') }}">
@csrf
...
@endforeach
                            ...
                            <div class="mx-auto mt-4 text-center">
                                <a href="{{ route('list.index') }}"><button class="btn btn-primary btn-lg mx-2" type="button"> クリア </button></a>
...
@if(count($summarys) > 0)
        <!-- 検索結果表示 -->
        <div class="alert alert-info mt-4 mx-auto max-w-3xl text-center text-sm md:text-2xl" role="alert">該当全レコード数：{{ session('total_count') }}件 ／ 合計作業時間 {{ sprintf("%.2fh", session('total_time')) }}</div>
