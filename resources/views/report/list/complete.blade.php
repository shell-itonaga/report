<x-app-layout>
    ...
    <x-slot name="header">
        <div class="text-base md:text-2xl">ユーザ設定 変更処理結果</div>
    </x-slot>
...
@else
            <div class="alert alert-success text-center my-5 text-xl" role="alert"><i class="fas fa-info-circle"></i>&nbsp;ユーザ設定が完了しました</div>
@endif
