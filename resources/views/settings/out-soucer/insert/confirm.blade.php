...
@csrf
                        <div class="col-sm mb-2">
                            ...
                            <input type="text" class="form-control-plaintext" readonly value="{{ $postData->user_name }}" id="user_name" name="user_name" required>
                        </div>

                        <div class="col-sm mb-2">
                            <label for="user_name_kana" class="col-form-label">フリガナ<span class="badge bg-danger mx-2 my-0">必須</span></label>
                            <input type="text" class="form-control-plaintext" readonly value="{{ $postData->user_name_kana }}" id="user_name_kana" name="user_name_kana" required>
                        </div>

                        <div class="col-sm mb-2">
                            <label for="email" class="col-form-label">メールアドレス<span class="badge bg-secondary mx-2 my-0">任意</span></label>
                            <input type="email" class="form-control-plaintext" readonly value="{{ $postData->email }}" id="email" name="email">
                        </div>
                        ...
                        <div class="col-sm mb-2">
                            ...
                            <input type="hidden" class="form-control" value="{{ $postData->password }}" id="password" name="password" required>
                        </div>
...
@endif
                        ...
                        <div class="mx-auto my-2 text-center">
                            ...
                            <button class="btn btn-primary btn-lg mx-2" type="submit" name="submit" value="insert">登&emsp;録</button>
                        </div>
                    </form>
                </div>
