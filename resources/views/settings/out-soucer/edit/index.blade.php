<x-app-layout>
    ...
    <x-slot name="header">
        <div class="text-base md:text-2xl">外注者編集</div>
    </x-slot>
...
@endif
                <div class="my-2 px-2 py-2 rounded-lg border-gray-300 border-1 bg-white">
                    <form name="input" class="mx-auto" method="POST" action="{{ route('edit.out-soucer.confirm') }}">
@csrf
...
@endif
                        ...
                        <div class="col-sm mb-2">
                            <label for="email" class="col-form-label">メールアドレス<span class="badge bg-secondary mx-2 my-0">任意</span><br><span class="col-form-label-sm text-primary"><i class="fas fa-info-circle"></i>&nbsp;未入力の場合、メールによるパスワードのリセットは利用出来ません</span></label>
                        ...
                        <div class="col-sm mb-2">
                            ...
                            <div class="border border-1 border-gray-500 rounded-lg p-2">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" id="user_status_on" name="user_status" value="1" @if ($user->user_status == 1 || empty(old('user_status')) || old('user_status') == 0) checked @endif>
